...
The synthetic demo audio in `docs/` is generated by `make_figures.py` and carries
the same licence. The example render of "Wanna Sleep" depicts my own copyrighted
recording; the image is fine to redistribute with this repo, the song is not.
